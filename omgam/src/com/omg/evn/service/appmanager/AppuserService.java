package com.omg.evn.service.appmanager;
...
public class AppuserService {
	 ...
	 * @throws
	 */
	public String findpagelist(int pageNumber,int pageSize,AppUser appUser) throws Exception {
		String hqlData = "from AppUser  where 1=1 ";
		String hqlCount = "select count(*)  from AppUser  where 1=1 ";
		String condition = "";
		
//		if (wherestr != null && !"".equals(wherestr.trim())&&!"undefined".equals(wherestr.trim())) {
//			condition += " and telephone like '%" + wherestr.trim() + "%'";
//		}	
		if (appUser != null && !"".equals(appUser)) {
			if(appUser.getTelephone() != null && !"".equals(appUser.getTelephone())){
				condition += " and telephone like '%" + appUser.getTelephone().trim() + "%'";
			}
			
			if(appUser.getStatus() != null && !"".equals(appUser.getStatus())){
				condition += " and status = '" + appUser.getStatus().trim() + "'";
			}
		}	
		...
		for(AppUser _appUser : appuserList){
			list.add(_appUser);
		}
		//总数
	 ...
	 * @Description: 删除
	 * @author zyen
	 * @date 2015-5-2 下午3:26:41 
	 * @param @param id     
	 * @return void    
	 * @throws
	 */
	public void delobjById(int id){
		baseDao.delById(AppUser.class,id);
	}
	 ...
	 * @Description: 根据id查询
	 * @author zyen
	 * @date 2015-5-10 上午10:43:41 
	 * @param @param id     
	 * @return void    
	 * @throws
	 */
	public AppUser findById(int id){
		return (AppUser) baseDao.findById(AppUser.class, id);
	}
